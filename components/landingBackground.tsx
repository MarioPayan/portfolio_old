...
const BackgroundSVG = ({theme}: {theme: Theme}): JSX.Element => {
  const svgProps = {
    dark: {
      fill: '#000000',
      stopColor1: '#000000',
  ...
  return (
    <svg xmlns='http://www.w3.org/2000/svg' width='100%' height='100%'>
      <rect fill={svgProps[theme].fill} width='540' height='450' />
      <defs>
        <linearGradient
          id='a'
          ...
          y1='0'
          y2='100%'
          gradientTransform='rotate(0,960,487)'>
          <stop offset='0' stopColor={svgProps[theme].stopColor1} />
          <stop offset='1' stopColor={svgProps[theme].stopColor2} />
        </linearGradient>
        <pattern patternUnits='userSpaceOnUse' id='b' width='444' height='370' x='0' y='0' viewBox='0 0 1080 900'>
          <g fillOpacity='0.1'>
